...
cat $1 | trim.sh | detokenizer.perl 2>/dev/null | txt2xml.sh | wrap-xml.py src zh en >$3.TER-src.xml
cat $2 | trim.sh | detokenizer.perl 2>/dev/null | txt2xml.sh | wrap-xml.py ref zh en >$3.TER-ref.xml
cat $3 | trim.sh | detokenizer.perl 2>/dev/null | txt2xml.sh | wrap-xml.pl $3.TER-src.xml en >$3.TER-sys.xml
